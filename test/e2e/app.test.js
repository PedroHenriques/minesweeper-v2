...
describe('App', function () {
  ...
  describe('on the landing page', function () {
    it('should render the game setup', async function () {
      ...
      assert.match(elemsData[3].children[1], / src=['"]\/games\/minesweeper-v2\/img\/dice\.png['"](\s|>)/i);
    ...
    describe('when the "start game" button is pressed', function () {
      it('should render the menu, the game header and the game minefield', async function () {
        ...
        assert.match(headerElemsData[0].children[0], / src=['"]\/games\/minesweeper-v2\/img\/timer\.png['"](\s|\>)/i);
        ...
        assert.match(headerElemsData[1].children[0], / src=['"]\/games\/minesweeper-v2\/img\/mine\.png['"](\s|>)/i);
        ...
        assert.match(headerElemsData[2].children[0], / src=['"]\/games\/minesweeper-v2\/img\/lives\.png['"](\s|>)/i);
